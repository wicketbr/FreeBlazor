/*! For license information please see quill.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function() {
        var t = {
                ...
                4541: function(t, e, n) {
                    ...
                    class s extends r.EmbedBlot {
                        ...
                        restore() {
                            ...
                            let c;
                            if (l.data = s.CONTENTS, e) c = e, (a || r) && (e.insertAt(e.length(), a + o), r && r.remove());
                    ...
                    class m extends u.ScrollBlot {
                        ...
                        insertContents(t, e) {
                            ...
                            n.length && (o && (o = o.split(l), l = 0), n.forEach((t => {
                                if ("block" === t.type) b(this.createBlock(t.attributes, o || void 0), 0, t.delta);
                                else {
                    ...
                    class k extends x.A {
                        constructor(t, e) {
                            super(t, e), t.root.addEventListener("drop", (e => {
                                e.preventDefault();
                                let n = null;
                                if (document.caretRangeFromPoint) n = document.caretRangeFromPoint(e.clientX, e.clientY);
                            ...
                            if (this.options = function(t, e) {
                                    ...
                                    return f ? e.formats && C.warn('Ignoring "formats" option because "registry" is specified') : f = e.formats ? ((t, e, n) => {
                                        ...
                                        return j.forEach((t => {
                                            ...
                                            let s = 0;
                                            for (; i;)
                                                if (r.register(i), i = "blotName" in i ? i.requiredContainer ?? null : null, s += 1, s > 100) {
                    ...
                    class S extends a.A {
                        ...
                        convert(t) {
                            let {
                                html: e,
                                text: n
                            } = t, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    ...
                    class f extends u.A {
                        ...
                        listen() {
                            this.quill.root.addEventListener("keydown", (t => {
                                ...
                                const [s, o] = this.quill.getLine(i.index), [c, u] = this.quill.getLeaf(i.index), [h, d] = 0 === i.length ? [c, u] : this.quill.getLeaf(i.index + i.length), p = c instanceof l.TextBlot ? c.value().slice(0, u) : "", g = h instanceof l.TextBlot ? h.value().slice(d) : "", m = {
                    ...
                    const p = {
                        bindings: {
                            ...
                            "header enter": {
                                ...
                                suffix: /^$/,
                                handler(t, e) {
                                    const [n, r] = this.quill.getLine(t.index), i = (new(o())).retain(t.index).insert("\n", e.format).retain(n.length() - r - 1).retain(1, {
                                        header: null
                                    });
                                    this.quill.updateContents(i, a.Ay.sources.USER), this.quill.setSelection(t.index + 1, a.Ay.sources.SILENT), this.quill.scrollSelectionIntoView()
                                }
                    ...
                    function i(t, g, m, b, y) {
                        ...
                        var E = t.substring(t.length - x),
                            w = function(t, l) {
                                ...
                                ], t.length > l.length && (c[0][0] = c[2][0] = e), c;
                                ...
                                return function(t, r) {
                                    ...
                                    for (var f = i - o, p = f % 2 != 0, g = 0, m = 0, b = 0, y = 0, v = 0; v < l; v++) {
                                        for (var A = -v + g; A <= v - m; A += 2) {
                                            ...
                                            else if (p && (q = a + f - A) >= 0 && q < c && -1 !== h[q] && _ >= (w = i - h[q])) return s(t, r, _, N)
                                        }
                                        for (var E = -v + b; E <= v - y; E += 2) {
                                            ...
                                            if (h[q] = w, w > i) y += 2;
                                                ...
                                                if ((x = a + f - E) >= 0 && x < c && -1 !== u[x])
                                                    if (N = a + (_ = u[x]) - x, _ >= (w = i - w)) return s(t, r, _, N)
                                            }
                                        }
                                    }
                                    return [
                    ...
                    class h {
                        ...
                        compose(t) {
                            ...
                            if (null != i && "number" == typeof i.retain && null == i.attributes) {
                                let t = i.retain;
                                for (;
                                    "insert" === e.peekType() && e.peekLength() <= t;) t -= e.peekLength(), r.push(e.next());
                            ...
                            for (; e.hasNext() || n.hasNext();)
                                ...
                                if (i.retain) {
                                    const a = {};
                                    if ("number" == typeof r.retain) a.retain = "number" == typeof i.retain ? t : i.retain;
                                    else if ("number" == typeof i.retain) null == r.retain ? a.insert = r.insert : a.retain = r.retain;
                                    else {
                    ...
                    var r, i, s, o, l = n(2673),
                        ...
                        I = function t(e, n, r, i, s) {
                            e !== n && h(n, (function(o, a) {
                                if (s || (s = new l.A), (0, N.A)(o)) R(e, n, a, r, t, i, s);
                                else {
                ...
                6003: function(t, e, n) {
                    ...
                    const v = class t extends p {
                        ...
                        path(e, n = !1) {
                            const [r, i] = this.children.find(e, n), s = [
                                [this, e]
                            ];
        ...
        return function() {
            ...
            class w extends x.A {
                ...
                static create(t) {
                    const e = super.create(t);
                    return e.setAttribute("href", this.sanitize(t)), e.setAttribute("rel", "noopener noreferrer"), e.setAttribute("target", "_blank"), e.setAttribute("aria-label", "Hidden Link Preview"), e
                }
                static formats(t) {
            ...
            class ot extends F.A {
                ...
                update(t) {
                    ...
                    this.controls.forEach((n => {
                        ...
                        } else if (null == t) i.classList.remove("ql-active"), i.setAttribute("aria-pressed", "false");
            ...
            class St extends qt {
                static TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" aria-label="Tooltip Input">', '<a class="ql-close"></a>', "</div>"].join("");
                constructor(t, e) {
            ...
            class jt extends qt {
                static TEMPLATE = ['<a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank" aria-label="Hidden Link Preview"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" aria-label="Tooltip Input">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join("");
